...
def build_model(args, stage="DiT"):
    if stage == "DiT":
        from svc.seed_vc.modules.flow_matching import CFM
        from svc.seed_vc.modules.length_regulator import InterpolateRegulator
        ...
        from svc.seed_vc.dac.model.dac import Encoder
        from svc.seed_vc.modules.quantize import FAquantizer
